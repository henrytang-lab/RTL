//===========================================================================
// Verilog file generated by Clarity Designer    09/30/2024    07:57:13  
// Filename  : csi_dphy_rx_wrap.v                                                
// IP package: CSI-2/DSI D-PHY Receiver 1.6                           
// Copyright(c) 2016 Lattice Semiconductor Corporation. All rights reserved. 
//===========================================================================

module csi_dphy_rx_wrap (
inout                                   clk_n_i,
inout                                   clk_p_i,
inout                                   d0_n_i,
inout                                   d0_p_i,
...
always @(posedge clk_byte_fr_i) begin
  if (reset_byte_fr_n_i == 1'd0) begin
    ...
    case (data_sel_i)
       ...
       4'd2   : data_o <= {dt_o,vc_o};
       4'd3   : data_o <= {ecc_o};
       4'd4   : data_o <= wc_o[7:0];
